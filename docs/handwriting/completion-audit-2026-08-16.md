...
**Repository baseline:** `origin/main` at `8a2d10fd894c3b1bceb30ea1ebeb7cb169baf4d8`
...
| 17 | Relevant local and remote checks pass | Complete locally; new PR gates pending | Backend passes 1268 tests / 3 expected xfails; frontend passes 394 tests across 41 files, lint, App.jsx cap, production build/API-base check, and provider-secret bundle scan. Linux, Windows, frontend, and Vercel checks passed through PR #49; the current evidence change still requires its own remote PR gates. |
| 18 | Reviewable PRs merged to current main | Complete for safe deliverables | PRs #31–#49 are merged; latest merge is `8a2d10fd894c3b1bceb30ea1ebeb7cb169baf4d8`. |
