...
rejects mutable or malformed overrides. Current revision `verity-ai-00021-glp`
proves the numeric references with both provider flags false; see
`current-main-disabled-deployment-evidence-2026-08-16.md`. Cloud Run checks the runtime
...
| Cloud Run secret-to-environment mapping | Complete for disabled revision `verity-ai-00021-glp` | [Current numeric version-`1` references, build/revision identity, and content-safe checks](current-main-disabled-deployment-evidence-2026-08-16.md) |
