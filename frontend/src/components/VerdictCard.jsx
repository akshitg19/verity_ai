  ...
  return (
    <span
      ...
      style={{
        ...
        border: `1px solid ${proven ? "var(--v-valid-border)" : "var(--v-unsupported-border)"}`,
        background: proven ? "var(--v-valid-bg)" : "var(--v-unsupported-bg)",
        color: proven ? "var(--v-valid)" : "var(--v-unsupported)",
        fontSize: 10,
        fontWeight: 700,
        letterSpacing: 0.2,
        whiteSpace: "nowrap",
